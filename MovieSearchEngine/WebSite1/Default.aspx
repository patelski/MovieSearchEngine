...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <div>
            <h2>
                <img src="/img/logo.png" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="Search.aspx" class="btn btn-primary btn-large">Search &raquo;</a></h2>
        </div>
    ...
    <div class="row">
        ...
        <div class="span4" style="color: #ffffcc;">
            ...
            <h2><a href="Best_Movies.aspx">Top 100 Movies</a></h2>
            <h2><a href="Worst_Movies.aspx">Worst 100 Movies</a></h2>
        </div>
