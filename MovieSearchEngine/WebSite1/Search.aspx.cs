    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (hits.totalHits < 10)
        {
            ...
            for (int j = 0; j < hits.totalHits; j++)
            {
                ...
                while (sq.Read())
                {
                    message = message + "<td height = \"185\" width= \"15%\" align=\"left\" valign=\"to\"> <img src='" + sq[0].ToString() + "' height = '185' width= '155'></img></td><td height = \"175\" width= \"85%\"><p><b><a href='Movie.aspx?id=" + i + "'>" + sq[1].ToString() + "</a></b></p><p>Movie Info :<font color =\"#ffffcc\">" + sq[2].ToString() + "</font></p></td>";
                }
                message = message + "</tr>";
                con.Close();
                sq.Close();
